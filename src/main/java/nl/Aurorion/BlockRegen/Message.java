...
public enum Message {
    ...
    RELOAD("Reload", "&a&lSuccesfully reloaded Settings.yml, Messages.yml, Blocklist.yml & re-filled the events!"),
    BYPASS_ON("Bypass-On", "&aBypass toggled on!"),
    BYPASS_OFF("Bypass-Off", "&cByppas toggled off!"),
    ...
    DATA_CHECK_ON("Data-Check-On", "&aEnterd Data-Check mode!"),
